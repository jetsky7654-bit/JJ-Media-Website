...
export default function AboutPage() {
  return <>
    ...
    <section className="section founder-section"><div className="container founder-grid"><div className="founder-media reveal"><img src="/assets/insta-6.webp" alt="Einblick in die Content-Arbeit von JJ-Media" loading="lazy"/><span>FOUNDER MEDIA · AUSTAUSCHBAR</span></div><div className="founder-copy reveal"><span className="eyebrow">Founder Point of View</span><h2>Menschen folgen keiner Agenturfassade.<br/><span className="serif">Sie vertrauen einer klaren Perspektive.</span></h2><p>Deshalb wird Jessica nicht hinter Leistungen versteckt: Haltung, Arbeitsweise und fachliche Einordnung werden zu einem festen Bestandteil des Contents. Dieser Bereich ist bereits als austauschbarer Founder-Baustein angelegt.</p><div className="founder-principles"><div><strong>01</strong><span>Klare Meinung statt Trendkopie</span></div><div><strong>02</strong><span>Einblicke statt Hochglanzfassade</span></div><div><strong>03</strong><span>Belege statt großer Versprechen</span></div></div></div></div></section>
